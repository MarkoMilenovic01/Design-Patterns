...
int main() {
    ...
    cout << d << endl;
    //cout.precision i cout << setprecision imaju istovetno ponašanje
    // preciznost koja se jednom postavi ostaje dok god se ne promeni.
    ...
    // 12 | 5    1100 | 0101 = 1101  12|5=13  & ^
    cout.flags(ios::right | ios::showbase | ios::dec);
